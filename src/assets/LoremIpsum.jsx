...
export function LoremIpsum({housingRef, inflationRef, bondRef}) {
    return (
      <>
        ...
        <img src={inflation_pic} className ="mb-10 md:ml-10 md pl-10" alt="" />
          ...
          <img src={housing_market} className ="mb-10 md:ml-10 md pl-10" alt="" />
          <h2 className="text-center text-2xl pt-12 mb-10">
          ...
          <img src={index_fund} className ="mb-10 md:ml-10 md pl-10" alt="" />
          <h2 
